...
Random check if site_id exists in dia_sam_05.
...
dia_sam_05[dia_sam_05$site_id=="BW_10001",] #no result
dia_sam_05[dia_sam_05$site_id=="RP_10002",] #no results
# Random site_id taken from dia_samples as a cross-check if code is correct.
dia_sam_05[dia_sam_05$site_id=="BW_AI025.00",] #185 results
...
```
site_id can be used to connect psm_sites and dia_sites since attribut it is found in both tables.