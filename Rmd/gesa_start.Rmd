...
psm_sam_year = dbGetQuery(con, " SELECT  psam.sample_id, psam.site_id,psam.date, psam.qualifier, psam.value, psam.unit, var.name, var.cas, var.pgroup, var.psm_type, var.pan_class,
...
samples <- merge(dia_sam_year, psm_sam_year, by = c("site_id", "year"))
